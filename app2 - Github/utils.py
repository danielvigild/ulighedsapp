    ...
    menu = dbc.Row([
        ...
        dbc.Col([
            dbc.Nav([
                ...
                dbc.NavItem([
                    html.A(
                        html.Img(id='icon-health', src='data:image/svg+xml;base64,{}'.format(encode_svg('health_dark.svg').decode()), style={'height': '2.2rem', 'verticalAlign': 'middle', 'paddingRight': '0.2rem'}),
                        href="/health",
                        ),
                ...
                dbc.NavItem([
                    html.A(
                        html.Img(id='icon-education', src='data:image/svg+xml;base64,{}'.format(encode_svg('edu_dark.svg').decode()), style={'height': '2.2rem', 'verticalAlign': 'middle', 'paddingRight': '0.2rem'}),
                        href='/education'
                    ),
                    dbc.Button('Uddannelse', href="/education", outline=True, color='dark', id='button-education', className='btn shadow-none')
                ]),
                dbc.NavItem([
                    html.Img(src='data:image/svg+xml;base64,{}'.format(encode_svg('doc_dark.svg').decode()), style={'height': '2.2rem', 'verticalAlign': 'bottom', 'paddingRight': '0.2rem'}),
...
def navigation2():
    return html.Div(dbc.Container(get_menu(), fluid=True), style={'backgroundColor': RF_gray, 'paddingTop':'0.5em', 'paddingBottom': '0.5em'})
...
labels_dict = {
    'gp': 'Kontakter med almen læge',
    'copd': 'Diagnosticeret med KOL',
    't2diabetes': 'Diagnosticeret med type 2-diabetes',
    'age1': '30 og 39',
    'age2': '40 og 49',
    'age3': '50 og 59',
    'age4': '60 og 65',
    ...
    # 'hage3': '40 og 49',
    # 'hage4': '50 og 59',
    # 'hage5': '60 år og derover',
    'admissions': 'Antal hospitalsindlæggelser',
    'nights': 'Antal dage indlagt på hospital',
    'hfpria': 'Antal års fuldført uddannelse',
    'labor': 'Opnået højere uddannelse end grundskole',
    'education': 'Opnået videregående uddannelse',
    'aekvivadisp': 'Ækvivaleret disponibel indkomst',
    'dispon': 'Disponibel indkomst',
    'perindkialt': 'Samlet indkomst',
    'loenmv': 'Lønindkomst',
    ...
    'diff_heritage': 'Forskel mht. herkomst',
    ...
    'danish': 'danskere',
    'danskere': 'danske',
    'nondanishnonwestern': 'indvandrere og efterkommere',
    'nonwestern': 'ikke-vestlige indvandrere og efterkommere',
